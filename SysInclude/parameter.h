...
#define     C_SysModuleEa                 2 // Module ������  ������
//#define     C_SlaveMEAEa                  7 // Slave BMS���� �����ϴ� ���� �� �µ� ���� ������
#define     C_ModuleMEAEa                 15 // Module���� �����ϴ� �� ���� �� �µ� ������ ������
#define     C_SlaveBMSEa                  4

#define     C_SysCellVoltEa               30//C_SysModuleEa*C_ModuleMEAEa // Battery Pack �� Cell ���� EA
#define     C_SysCellTempEa               30//C_SysModuleEa*C_ModuleMEAEa // Battery Pack �� Cell �µ� EA
#define     C_CellNum                     30
#define     C_HmiCellVoltCount            9//C_SysCellVoltEa/3 //CAN TX  ���� ���� Cell ���� ���� ������
#define     C_HmiCellTempCount            9//C_SysCellTempEa/3 //CAN TX  ���� ���� Cell �µ� ���� ������
